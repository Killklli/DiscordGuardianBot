...
namespace DiscordGuardianBot
{
    public class Permissions
    {
        ...
        public static OverwritePermissions ChannelPermissions(string type)
        {
            ...
            else if (type.ToLower() == "team-lead")
            {
                return new OverwritePermissions(viewChannel: PermValue.Allow, sendMessages: PermValue.Allow, readMessageHistory: PermValue.Allow, connect: PermValue.Allow, speak: PermValue.Allow, addReactions: PermValue.Allow, embedLinks: PermValue.Allow, attachFiles: PermValue.Allow, useExternalEmojis: PermValue.Allow, manageMessages: PermValue.Allow, manageChannel: PermValue.Allow,useVoiceActivation: PermValue.Allow, muteMembers: PermValue.Allow, moveMembers: PermValue.Allow,manageRoles: PermValue.Allow);
            }
            else
            {
                // return inherit
